    ...
    <aside id="separate-sidebar" class=" z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 mb-6 font-medium ">
                <li>
                    <a href="{{ url('/dashboard') }}" class="flex items-center p-2  text-green-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group bg-green-100 border-l-4 border-green-600">
            ...
            <ul class="pt-4 mt-4 space-y-2 mb-6 font-medium border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="{{url('/profile')}}" class="flex items-center p-2 text-green-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                            <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                            <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                        </svg>
            ...
            <ul class="pt-4 mt-4 space-y-2 mb-6 font-medium border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a href="{{ route('user-management') }}"  class="flex items-center p-2 text-green-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
